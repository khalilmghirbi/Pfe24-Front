...
////////////////////////////////////ajouter sans ts 
getHotelsByHopitalId(hopital_id: any) {
  return this.http.get('http://localhost:4000/hotelbyhopital/' + hopital_id);
}

getContactsByHopitalId(hopital_id: any) {
  return this.http.get('http://localhost:4000/contactbyhopital/' + hopital_id);
}

getManagersByHopitalId(hopital_id: any) {
  return this.http.get('http://localhost:4000/managersbyhopital/' + hopital_id);
}

getReviewsByHopitalId(hopital_id: any) {
  return this.http.get('http://localhost:4000/avisbyhopital/' + hopital_id);
}

getMediaByHopitalId(hopital_id: any) {
  return this.http.get('http://localhost:4000/mediabyhopital/' + hopital_id);
}

getDoctorsByHopitalId(hopital_id: any) {
  return this.http.get('http://localhost:4000/doctorbyhopital/' + hopital_id);
}

getTreatmentsByHopitalId(hopital_id: any) {
  return this.http.get('http://localhost:4000/treatmentbyhopital/' + hopital_id);
}
